...
var DoReMeetEffect_module = require('./DoReMeetEffect.module.scss.js');
...
var DoReMeetEffect = function DoReMeetEffect(_ref) {
  ...
  var optionStyle = React.useMemo(function () {
    ...
    return {
      '--sekai-color': sekaiColors.colorsSekai[sekaiKeys[currentSekaiIndex]]
    };
  ...
  return /*#__PURE__*/React.createElement("span", _extends({
    ...
    onKeyDown: operation.fireOnEnterKey(handleDeReMeetEffect)
  }, rest, {
    className: clsx(DoReMeetEffect_module["sekai-doremeet-effect-".concat(modeTheme)], rest.className),
