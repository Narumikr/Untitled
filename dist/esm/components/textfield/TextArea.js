...
var TextArea = function TextArea(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    ...
    className: clsx(styles['sekai-textarea'], styles["sekai-textarea-".concat(modeTheme)]),
    style: {
      resize: resize
    },
    value: value || '',
...
var TextCounter = function TextCounter(_ref2) {
  ...
  return /*#__PURE__*/React.createElement(AnnotationText, {
    className: clsx(styles['sekai-text-counter'])
